...
Мекен жайы: Казахстан Адрес: Республика
Республикасы, Алматы қ., Казахстан, г. Алматы,
Назарбаев данғылы, 103 проспект Назарбаева, 103
...
на заседании УМС
Протокол № **\_\_\_** от «\_**\_» \*\***\_\_\_**\*\*** 202\_\_ г.
