...
«Колледж Хексдет» ЖШС ТОО «Колледж Хексдет»

Мекен жайы: Казахстан Республикасы, Адрес: Республика Казахстан,
Алматы қ., Назарбаев данғылы, 103 г. Алматы, проспект Назарбаева, 103

e-mail: itcollege@hexly.kz e-mail: itcollege@hexly.kz
...
Протокол № **\_\_\_** от «\_**\_» ******\_\_******** 202\_\_\_ г.
...
function getCategoryProgressStats(goals) {
  ...
  Object.keys(categoryStats).forEach((category) => {
    ...
    categoryStats[category].averageProgress = Math.round(
      totalProgress / categoryGoals.length,
    );
  });
...
**Студент:** **\*\*\*\***\_\_\_\_**\*\*\*\*** / Степанов Тим /

**Преподаватель:** **\*\*\*\***\_\_\_\_**\*\*\*\*** / [ФИО] /
